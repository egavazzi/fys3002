## ==================================================================== ##
# I don't remember if the changes to the original `tec_map_example.py` I 
# did here were to fix something not working or if it was just to test 
# and understand things. The original file seems to work and produce 
# figures, so the hypothesis "test and understand" is more plausible
## ==================================================================== ##
